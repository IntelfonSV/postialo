      ...
      <div className="w-full bg-white">
        ...
        <div className="p-8 bg-white border-b border-gray-200 text-center">
          ...
          <p className="mt-3 text-gray-600 max-w-3xl mx-auto text-base">
            ¡Hola! 👋 Gracias por activar su demo. Para que podamos comenzar a
            publicar contenido en sus páginas y mostrarle todo el potencial de
            la plataforma, necesitamos que nos ayude con dos pasos muy
            sencillos:
          </p>
        </div>
        ...
        <div className="p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-xl border border-gray-200 shadow-sm h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
              ...
              <p className="font-medium text-gray-600 ml-12 mb-6">
                Esto nos permitirá publicar contenido durante la demo. Siga estos
                pasos:
              </p>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 font-medium ml-12">
                ...
                <li>
                  Seleccione <strong>Configuración de página</strong>.
                </li>
                <li>
                  Entre a la opción <strong>Acceso a la página</strong>.
                </li>
                <li>
                  En <strong>Personas con acceso a tareas</strong>, seleccione{" "}
                  <strong>Agregar</strong>.
                </li>
                <li>
                  Escriba nuestro contacto: <strong>Marcos Salvador</strong>.
                </li>
                <li>
                  Otorgue acceso con permisos de{" "}
                  <strong>Contenido</strong>.
                </li>
                <li>Ingrese su contraseña de Facebook y confirme.</li>
              </ol>
            </div>
            ...
            <div className="p-8 rounded-xl border border-gray-200 shadow-sm h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
              ...
              <p className="font-medium text-gray-600 ml-12 mb-6">
                Estos identificadores son necesarios para conectar su demo con
                PostIAlo.
              </p>
              <ol className="list-decimal list-inside space-y-3 text-gray-700 font-medium ml-12">
                <li>
                ...
                <li>
                  En el menú lateral, seleccione <strong>Configuraciones</strong>
                  .
                </li>
                <li>
                ...
                <li>
                  Diríjase a la sección de <strong>Páginas</strong>:
                  <ul className="list-disc list-outside ml-10 mt-2 space-y-2">
                    <li>
                      <strong>Para Facebook:</strong> seleccione la página y
                      copie el número que aparece como{" "}
                      <strong>Identificador</strong>.
                    </li>
                    <li>
                      <strong>Para Instagram:</strong> entre a{" "}
                      <strong>Cuentas de Instagram</strong>, seleccione su
                      cuenta y copie el número que aparece como{" "}
                      <strong>Identificador</strong>.
                    </li>
                  </ul>
                </li>
          ...
          <div
            ...
            style={{ backgroundColor: "#eef2f9", borderLeftColor: "#F94B53" }}
          >
          ...
          <div className="mt-12 max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="p-0.5 rounded-lg bg-blue-500 h-full">
                  <input
                    ...
                    onChange={(e) => setData('facebook_id', e.target.value)}
              ...
              <div>
                ...
                <div className="p-0.5 rounded-lg bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 h-full">
                  <input
                    type="text"
                    id="instagram_id"
                    name="instagram_id"
            ...
            <button className="mt-12 bg-[#002073] text-white font-bold py-3 px-10 rounded-lg shadow-md hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105">
              Continuar
            </button>
          </div>
        </div>
        ...
        <div className="p-6 text-center bg-gray-100 text-gray-500">
          <p>
            Con este procedimiento, PostIAlo tendrá el acceso necesario mientras
            tú conservas el control total.
          </p>
        </div>
      </div>
    </div>
