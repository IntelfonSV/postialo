...
export default function BillingPlans() {
    ...
    return (
      ...
      `}</style>
            ...
            <header className="header-gradient relative overflow-hidden px-6 pb-32 pt-20 text-center text-white">
                ...
                <div className="relative z-10 mx-auto max-w-4xl">
                    ...
                    <p className="mx-auto max-w-2xl text-xl font-light text-blue-100 md:text-2xl">
                        Estructura de planes diseñada para escalar tu negocio
                ...
                <div className="flex justify-center gap-4">
                    ...
                    >
                        <div className="mb-8">
                            ...
                            <h3 className="mb-2 text-2xl font-black italic text-postialo-blue">
                                Básico
                            </h3>

                            <div className="mb-2 flex items-baseline gap-1">
                                <span className="text-5xl font-black text-postialo-blue">
                                    $25.00
                                </span>
                            ...
                            <div className="mb-6 rounded-2xl border border-blue-100 bg-blue-50/50 p-4">
                                ...
                                <ul className="space-y-2 text-[12px] leading-tight text-gray-700">
                                    <li className="flex items-center gap-2">
                                        ...
                                        <span>
                                            Inicia con <b>14 publicaciones</b>{" "}
                                            base.
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <div className="mt-4 border-t border-blue-100 pt-4">
                                    <p className="text-[11px] italic leading-relaxed text-gray-500">
                                        <b className="not-italic text-postialo-blue">
                                            Ejemplo:
                                        </b>{" "}
                                        Si tu negocio requiere 20 publicaciones
                                        mensuales, el costo se ajusta
                                        proporcionalmente y pagarás solo{" "}
                                        <b>$37 al mes</b> ($25 del plan base +
                                        excedente).
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="mb-10 flex-grow space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm leading-snug text-gray-600">
                                    <b>Portal SaaS:</b> Programación total de
                                    redes sociales.
                                </p>
                            </div>
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm leading-snug text-gray-600">
                                    <b>IA Generativa:</b> Creación de copys e
                                    imágenes desde cero.
                                </p>
                            </div>
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm leading-snug text-gray-600">
                                    <b>IA de Optimización:</b> Regenera y pule
                                    contenidos.
                                </p>
                            </div>
                        </div>
                        ...
                        <button
                            className="btn-shiny w-full rounded-2xl bg-postialo-blue py-4 text-sm font-bold text-white shadow-lg shadow-blue-100 transition-transform active:scale-95"
                            onClick={() => router.post(route("users.demo"))}
                        >
                            Comenzar ahora
                        </button>
                    </div>
                    ...
                    >
                        ...
                        <div className="mb-8">
                            ...
                            <h3 className="mb-2 text-2xl font-black italic text-postialo-red">
                                Profesional
                            </h3>
                        ...
                        <div className="mb-10 flex-grow space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-postialo-blue">
                                        Asistente Virtual (Bot IA)
                                    </p>
                                    <p className="text-[12px] text-gray-500">
                                        Respuestas 24/7 basadas en tus FAQs.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm leading-snug text-gray-600">
                                    <b>Módulo Lead Generation:</b> Captura de
                                    datos de clientes.
                                </p>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm leading-snug text-gray-600">
                                    <b>Dashboard Analítico:</b> Métricas de
                                    interacciones.
                                </p>
                            </div>
                            ...
                            <div className="mt-4 rounded-2xl border border-red-100 bg-red-50/50 p-4">
                                ...
                                <p className="text-[11px] leading-tight text-gray-600">
                                    Inclusión sin costo en el Marketplace
                                    Gastronómico.
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        <div className="mb-8">
                            ...
                            <h3 className="mb-2 text-2xl font-black italic text-purple-600">
                                Agencia
                            </h3>
                        ...
                        <div className="mb-10 flex-grow space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm leading-snug text-gray-600">
                                    <b>Catálogo Inteligente:</b> Integración de
                                    productos directa.
                                </p>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm leading-snug text-gray-600">
                                    <b>IA de Edición Avanzada:</b> Modifica
            ...
            <section
                ref={addRevealRef}
                className="reveal mx-auto mb-24 max-w-6xl px-6 hidden"
            >
                        ...
                        <table className="w-full border-collapse text-left">
                            <thead>
                                <tr className="bg-gray-50/80">
                                    ...
                                    <th className="px-6 py-5 text-center text-sm font-black uppercase text-postialo-blue">
                                        Básico
                                    </th>
                                    <th className="px-6 py-5 text-center text-sm font-black uppercase text-postialo-red">
                                        Profesional
                                    </th>
                                    <th className="px-6 py-5 text-center text-sm font-black uppercase text-purple-600">
                                        Agencia
                                    </th>
                                </tr>
                            </thead>
                            <tbody className="text-sm">
                                <tr className="border-b border-gray-50">
                                    <td className="px-8 py-5 font-bold italic text-gray-700">
                                        Precio Mensual
                                    </td>
                                    <td className="px-6 py-5 text-center font-bold text-postialo-blue">
                                        $25
                                    </td>
                                    <td className="px-6 py-5 text-center font-bold text-postialo-blue">
                                        $125
            ...
            <footer className="mx-auto max-w-5xl px-6 pb-20 text-center">
                <div className="mb-12 rounded-[2rem] border border-blue-100 bg-blue-50/50 p-8">
                    <p className="mx-auto max-w-2xl text-xs font-medium italic leading-relaxed text-blue-400">
                        ...
                        Opción de conexión con sistemas externos (CRM, ERP,
                        etc.) y/o para integración con bot de WhatsApp mediante
                ...
                <div className="flex flex-col items-center justify-between gap-6 border-t border-gray-100 pt-8 md:flex-row">
                    ...
                    <p className="text-xs font-medium text-gray-400">
                        © 2026 PostIAlo. Tecnología salvadoreña conectando al
                        mundo.
                    </p>
                </div>
            </footer>
